  ...
  return (
    <div className="p-3">
      ...
      <div className="pl-4">
        ...
        <ul className="pl-5">
          <li>
            Ghayoor Bawary - Chairperson
          </li>
          <li>
            Mohib Utmankhil - Vice Chairpersonn
          </li>
          <li>
            Qudratullah Hiwadpal - Program Manager
          </li>
          <li>
            Lima Madomi - Marketing & Outreach Lead
          </li>
          <li>
            Geety Mahdizada - Logistics Coordinator
          </li>
          <li>
            Sajia Yarmal - Coordinator
          </li>
        </ul>
        ...
        <ul className="pl-5">
          ...
          <li>
            Rooh Afza Abubakr - Program Coordinator
          </li>
          <li>
            Khpal Wak Shinwari - Operations Coordinator
          </li>
          <li>
            Masuma Rasuli - Social Media/Communication Coordinator
          </li>
          <li>
            Web Coordinator
          </li>
        ...
        <ul className="pl-5">
          ...
          <li>
            Head of Global Youth IGF
          </li>
          <li>
            Jenna Manhau Fung, Asia Pacific Youth IGF
          </li>
          <li>
            Jamal Noorzaie
          </li>
        ...
        <p>
          ...
          woven with threads of passion, commitment, and unwavering belief in the power of Afghan
          youth.
          <br />
          <br />
          Join us on this journey, as we pen the future chapters of Afghanistan's digital story.
        </p>
      </div>
    </div>
  );
